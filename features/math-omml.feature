Feature: OMML (Office Math Markup Language) Support
  ...
  Scenario: Add basic math equation to slide
    ...
    When I add a math equation "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:r><m:t>x = 2</m:t></m:r></m:oMath>"
  ...
  Scenario: Add fraction equation to slide
    Given a presentation with one slide
    When I add a math equation with fraction "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:f><m:num><m:r><m:t>x</m:t></m:r></m:num><m:den><m:r><m:t>2</m:t></m:r></m:den></m:f></m:oMath>"
    Then the slide should contain one math shape
  ...
  Scenario: Add superscript equation to slide
    Given a presentation with one slide
    When I add a math equation with superscript "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:r><m:t>x</m:t></m:r><m:sSup><m:e><m:r><m:t>2</m:t></m:r></m:e></m:sSup></m:oMath>"
    Then the slide should contain one math shape
    And the math shape should contain "x²"

  Scenario: Add radical equation to slide
    Given a presentation with one slide
    When I add a math equation with radical "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:rad><m:radPr/><m:deg/><m:e><m:r><m:t>x</m:t></m:r></m:e></m:rad></m:oMath>"
    Then the slide should contain one math shape
    And the math shape should contain a square root of "x"

  Scenario: Add n-ary operator equation to slide
    Given a presentation with one slide
    When I add a math equation with summation "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:nary><m:naryPr><m:chr val='∑'/><m:limLoc val='undOvr'/></m:naryPr><m:sub><m:r><m:t>i=1</m:t></m:r></m:sub><m:sup><m:r><m:t>n</m:t></m:r></m:sup><m:e><m:r><m:t>i</m:t></m:r></m:e></m:nary></m:oMath>"
    Then the slide should contain one math shape
    And the math shape should contain a summation from i=1 to n of i

  Scenario: Position and size math equation
    Given a presentation with one slide
    When I add a math equation "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:r><m:t>E = mc²</m:t></m:r></m:oMath>"
  ...
  Scenario: Add multiple math equations to slide
    Given a presentation with one slide
    When I add a first math equation "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:r><m:t>a² + b²</m:t></m:r></m:oMath>"
    And I add a second math equation "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:r><m:t>= c²</m:t></m:r></m:oMath>"
  ...
  Scenario: Replace OMML content in existing math equation
    Given a presentation with one slide containing a math equation
    When I replace the OMML content with "<m:oMath xmlns:m='http://purl.oclc.org/ooxml/officeDocument/math'><m:r><m:t>y = mx + b</m:t></m:r></m:oMath>"
